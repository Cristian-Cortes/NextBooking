...
<div class="agileits-services" id="ubicacion">
	<div class="container">
		<br>
		<h2 class="heading text-capitalize">Habitacion SOL</h2>
		<br>
		<br>
		<div class="container-slider">
			<div class="slider" id="slider">
				<div class="slider_section"><img src="img/habitaciones/SOL/SOL1.jpg" class="slider_img"></div>
				<div class="slider_section"><img src="img/habitaciones/SOL/SOL2.jpg" class="slider_img"></div>
				<div class="slider_section"><img src="img/habitaciones/SOL/SOL3.jpg" class="slider_img"></div>
				<div class="slider_section"><img src="img/habitaciones/SOL/SOL4.jpg" class="slider_img"></div>
			</div>
			<div class="slider_btn slider_btn-right" id="btn-right">&#62;</div>
			<div class="slider_btn slider_btn-left" id="btn-left">&#60;</div>
		</div>
		<br>
		<p class="mt-4" style="color: black">Habitacion muy amplia que incluye cama kingsais, Vista al sol, Baño completo mas tina de baño.</p>
		<br>
		<h6 style="text-align: left;">Caracteristicas:</h6>
		<p class="mt-4" style="text-align: left;">*Habitacion para dos personas<br>*Medidas de Higiene adecuadas<br>*No fumar</p>
		<h6 style="text-align: right;">Servicios incluidos:</h6>
		<p class="mt-4" style="text-align: right;">*Aire acondicionado<br>*Wifi gratis<br>*Estacionamiento<br>*Balcon</p>
		
		<span>$680/noche</span><br><br>
		<a class="btn btn-warning" href="Catalogo.html">Regresar al catalogo</a>
		<a class="btn btn-success" href="reservar.php">Reservar</a>
	</div>
</div>
